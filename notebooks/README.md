...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  01_build_dataset.ipynb          Combine raw MCL data into unified dataset  │
│           │                                                                 │
│           ▼                                                                 │
│  02_append_new_data.ipynb        Add incremental data updates (optional)    │
│           │                                                                 │
│           ▼                                                                 │
...
**Purpose:** Combine multiple raw data sources into a single unified dataset

**Inputs:**
- MCL exports for MPs (from combined query results)
- MCL exports for Prominent Politicians (multiple files)
- MCL exports for Extremists (multiple files)
- Re-elected MPs list (for experience classification)

**Outputs:**
- `combined_datasets/italian_political_accounts_TIMESTAMP.rds`

**Key Operations:**
- Apply surface ID fallbacks for Stories content
- Classify MPs as re-elected vs. newly elected
- Tag posts with main_list and sub_list categories
- Add standardized date/time variables

---

### 02_append_new_data.ipynb
**Purpose:** Add incremental data updates to existing dataset

**Inputs:**
- Previous combined dataset
- New MCL subset exports

**Outputs:**
- Updated `combined_datasets/italian_political_accounts_TIMESTAMP.rds`

**Key Operations:**
- Align column structures between old and new data
- Verify no unexpected new accounts appear
- Deduplicate posts
- Generate monthly breakdown comparisons

**Note:** This notebook is optional and only needed when adding new time periods.
...
**Inputs:**
- Combined dataset from Notebook 01/02
...
1. **Notebook 01:** Update file paths and group classification logic
2. **Notebook 02:** Optional - only if adding incremental data
